...
WithPermissions.propTypes = {
  userPermissions: _propTypes2.default.arrayOf(_propTypes2.default.string).isRequired,
  has: _propTypes2.default.arrayOf(_propTypes2.default.string).isRequired,
